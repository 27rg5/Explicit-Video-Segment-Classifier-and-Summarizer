...
# python -W ignore eval.py --root_dir_path ~/cls_data_1_min --experiment_name attention_fusion_additional_exp_no_caption_increased_params --get_classified_list --eval_dataset_type val

# echo " "
# echo "attention_fusion_default_networks_self_attention_21epochs_caption_modality_multihead_2_heads"
# python -W ignore eval.py --root_dir_path ~/cls_data_1_min --experiment_name attention_fusion_default_networks_self_attention_21epochs_caption_modality_multihead_2_heads --get_classified_list --eval_dataset_type val --mlp_fusion --mlp_object_path '/home/shaunaks/lda_gridsearch_experiments/bertopic/best_model_bertopic_test_f1_0.782608695652174.pkl'

echo " "
echo "video_modality"
python -W ignore eval.py --root_dir_path ~/cls_data_1_min --experiment_name video_modality --get_classified_list --eval_dataset_type val --vanilla_fusion
